...
<br></i></strong>
    ...
    <div class="col-md-5">
        ...
        <div class="form-group">
            Email <asp:Label ID="Label1" runat="server" Text="*" ForeColor="Red"></asp:Label>
            <div >
            ...
            <div >
              ...
              <div class="form-group">
             Name <asp:Label ID="Label3" runat="server" Text="*" ForeColor="Red"></asp:Label>
            <div >
         ...
         <div class="form-group">
            Message <asp:Label ID="Label2" runat="server" Text="*" ForeColor="Red"></asp:Label>
            <div >
        ...
        <p style="color: #fff;">
            <i class="fa fa-map-marker">57 Willis Street<br>
                Auckland 6011<br>New Zealand</i>
